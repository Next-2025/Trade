...
(self.webpackChunk_am5 = self.webpackChunk_am5 || []).push([[6450], {
    6901: function(e, t, i) {
        ...
        class b extends n.j {
            constructor() {
                ...
                Object.defineProperty(this, "zoomOutButton", {
                    ...
                    configurable: !0,
                    writable: !0,
                    value: this.topPlotContainer.children.push(h.z.new(this._root, {
                        themeTags: ["zoom"],
                        icon: c.T.new(this._root, {
            ...
            _removeSeries(e) {
                ...
                const t = e.get("xAxis");
                t && (u.remove(t.series, e),
                t.markDirtyExtremes());
                const i = e.get("yAxis");
                i && (u.remove(i.series, e),
                i.markDirtyExtremes());
            ...
            handleWheel(e) {
                ...
                "panX" !== t && "panXY" !== t || 0 == l || this.xAxes.each((e => {
                    if (e.get("panX")) {
                        ...
                        a = r[0],
                        o = r[1],
                        this._handleWheelAnimation(e.zoom(a, o))
                    }
                }
                )),
            ...
            _handleSetWheel() {
                ...
                "none" !== e || "none" !== t ? (this._wheelDp = i.events.on("wheel", (i => {
            ...
            _getWheelSign(e) {
                let t = 1;
                return e.get("renderer").get("inversed") && (t = -1),
                t
            }
            _fixWheel(e, t) {
                const i = t - e;
            ...
            _handlePlotDown(e) {
                ...
                if ((this.get("pinchZoomX") || this.get("pinchZoomY")) && t.pointerId && m.keys(i._downPoints).length > 0) {
                    ...
                    e && (this._downStartX = e.get("start", 0),
                    this._downEndX = e.get("end", 1)),
                    t && (this._downStartY = t.get("start", 0),
            ...
            _handlePlotMove(e) {
                ...
                if (this.get("pinchZoomX") || this.get("pinchZoomY")) {
                    ...
                    if (i && (this._movePoints[i] = e.point,
                    ...
                    if (a) {
                        ...
                        this.xAxes.each((e => {
                            if (e.get("panX")) {
                                ...
                                let r = a + n
                                  , l = o + n;
                                l - r < 1 + 2 * e.get("maxDeviation", 1) && (e.set("start", r),
                                e.set("end", l))
                            }
                        }
                        )),
                ...
                if (e) {
                    ...
                    i && t) {
                        ...
                        if (u.each(a, (e => {
                            ...
                            if (i) {
                                let a = 0;
                                a = "x" == s || "x!" == s ? Math.abs(t.x - i.x) : "y" == s || "y!" == s ? Math.abs(t.y - i.y) : Math.hypot(t.x - i.x, t.y - i.y),
                                a < n && (n = a,
                                o = e)
                            }
                        }
            ...
            _prepareChildren() {
                ...
                this.isDirty("cursor")) {
                    const e = this._prevSettings.cursor
                      , t = this.get("cursor");
                    t !== e && (this._disposeProperty("cursor"),
                    e && e.dispose(),
                    t && (t._setChart(this),
                    this._addCursor(t),
                    this._pushPropertyDisposer("cursor", t.events.on("selectended", ( () => {
                ...
                if (this.isDirty("scrollbarX")) {
                    ...
                    t !== e && (this._disposeProperty("scrollbarX"),
                    e && e.dispose(),
                    t && (t.parent || this.topAxesContainer.children.push(t),
                    this._pushPropertyDisposer("scrollbarX", t.events.on("rangechanged", (e => {
                ...
                if (this.isDirty("scrollbarY")) {
                    ...
                    t !== e && (this._disposeProperty("scrollbarY"),
                    e && e.dispose(),
                    t && (t.parent || this.rightAxesContainer.children.push(t),
                    this._pushPropertyDisposer("scrollbarY", t.events.on("rangechanged", (e => {
            ...
            _processSeries(e) {
                ...
                e.get("stacked") && (e._markDirtyKey("stacked"),
                u.each(e.dataItems, (e => {
                    e.set("stackToItemY", void 0),
                    e.set("stackToItemX", void 0)
                }
                ))),
                e._markDirtyAxes(),
                i.markDirtyExtremes(),
            ...
            _handleCursorSelectEnd() {
                const e = this.get("cursor")
                  ...
                  , a = Math.min(1, Math.max(0, e.getPrivate("positionX", .5)))
                  , o = Math.min(1, Math.max(0, e.getPrivate("positionY", .5)));
                this.xAxes.each((e => {
                    if ("zoomX" === t || "zoomXY" === t) {
            ...
            _updateChartLayout() {
                ...
                s.set("paddingLeft", e),
                s.set("paddingRight", t)
            }
            processAxis(e) {
                this.get("cursor") && (this.addDisposer(e.on("start", ( () => {
                    this._updateCursor()
                }
                ))),
            ...
            _handleAxisSelection(e, t) {
                ...
                -1 != this.xAxes.indexOf(e)) {
                    if (t || e.getPrivate("updateScrollbar")) {
                        let e = this.get("scrollbarX");
                        !e || e.getPrivate("isBusy") && !t || (e.setRaw("start", i),
                        e.setRaw("end", s),
                        e.updateGrips())
                    }
            ...
            inPlot(e) {
                const t = this.plotContainer
                  ...
                  , s = t.toGlobal(e);
                if (e.x >= -.5 && e.y >= -.5 && e.x <= t.width() + .5 && e.y <= t.height() + .5)
                    return !0;
                if (i)
                    for (let e = i.length - 1; e >= 0; e--) {
                        ...
                        if (t != this) {
                            const e = t.plotContainer
                              ...
                              , o = e.toLocal(a);
                            if (o.x >= -.1 && o.y >= -.1 && o.x <= e.width() + .1 && o.y <= e.height() + .1)
                                return !0
                        }
                    }
                return !1
            ...
            arrangeTooltips() {
                ...
                const n = [];
                let r, h, c = 0, m = 1 / 0, p = this._movePoint, b = this.get("maxTooltipDistance"), _ = this.get("maxTooltipDistanceBy", "xy");
                d.isNumber(b) && this.series.each((e => {
                    if (!e.isHidden()) {
                        const t = e.get("tooltip");
                        if (t) {
                            let i = t.get("pointTo");
                            if (i) {
                                ...
                                "x" == _ ? t = Math.abs(p.x - i.x) : "y" == _ && (t = Math.abs(p.y - i.y)),
                                t < m && (m = t,
                                r = e,
                                h = i)
                            }
                        ...
                        if (s) {
                            if (b >= 0) {
                                ...
                                if (s && h && e != r) {
                                    ...
                                    "x" == _ ? e = Math.abs(h.x - s.x) : "y" == _ && (e = Math.abs(h.y - s.y)),
                                    e > b && (i = !0)
                                }
                            } else
                                -1 == b && e != r && (i = !0);
                            this.inPlot(this._tooltipToLocal(s)) && t.dataItem ? i || (c += s.y) : i = !0,
                            i || e.isHidden() || e.isHiding() ? t.hide(0) : (t.show(),
                            n.push(t),
                            x.push(e))
                        }
                    }
                ...
                this.get("arrangeTooltips")) {
                    ...
                    if (c / t > i / 2 + a.y) {
                        ...
                        n.reverse(),
                        n.sort(( (e, t) => g.HO(e.get("pointTo").y, t.get("pointTo").y)));
                        let t = 0;
                        if (u.each(n, (i => {
                            let n = i.height()
                              , r = i.get("centerY");
                            r instanceof l.gG && (n *= r.value),
                            n += i.get("marginBottom", 0),
                            i.set("bounds", {
                                left: a.x,
                                top: t,
                                right: o.x,
        ...
        Object.defineProperty(b, "classNames", {
            ...
            configurable: !0,
            writable: !0,
            value: n.j.classNames.concat([b.className])
        })
    },
    55: function(e, t, i) {
        i.d(t, {
        ...
        class g extends s.Q {
            setupDefaultRules() {
                ...
                });
                {
                    ...
                    (0,
                    r.v)(s, "stroke", e, "alternativeBackground")
                }
                {
                ...
                }
                {
                    ...
                    (0,
                    r.v)(t, "fill", e, "alternativeBackground")
                }
                i("Axis").setAll({
                    start: 0,
                    end: 1,
                ...
                i("DateAxis").setAll({
                    ...
                    fillRule: e => {
                        ...
                        if (t) {
                            ...
                            if (h = l.round(new Date(h), r.timeUnit, r.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime(),
                            null != s && null != a) {
                ...
                });
                {
                    ...
                    (0,
                    r.v)(t, "fill", e, "positive"),
                    (0,
                    r.v)(t, "stroke", e, "positive")
                }
                {
                    const t = i("Rectangle", ["column", "autocolor"]).states.create("dropFromOpen", {});
                    (0,
                    r.v)(t, "fill", e, "negative"),
                    (0,
                    r.v)(t, "stroke", e, "negative")
                }
                ...
                });
                {
                    ...
                    (0,
                    r.v)(t, "stroke", e, "secondaryButtonText")
                }
    ...
    3355: function(e, t, i) {
        ...
        class d extends s.W {
            ...
            _afterNew() {
                ...
                l.supports("keyboardevents") && this._disposers.push(l.addEventListener(document, "keydown", (e => {
            ...
            _handleLineMove(e, t) {
                ...
                let a;
                if (s && s.xAxes.length) {
                    this._root.focused(this.lineX) ? (i = "positionX",
                    a = s.xAxes.getIndex(0)) : this._root.focused(this.lineY) && (a = s.yAxes.getIndex(0),
                    i = "positionY");
                    let o = 1;
                    if (t && (o = 5),
                    a) {
                        let t, s = a.get("renderer").get("inversed", !1);
                        "ArrowRight" == e || "ArrowDown" == e ? t = 1 : "ArrowLeft" == e || "ArrowUp" == e ? t = -1 : "Tab" == e && (t = 0),
                        null != t && (s && (t *= -1),
                        this.set(i, a.nextPosition(t * o)))
                    }
                }
            }
            _handleLineFocus() {
            ...
            _prepareChildren() {
                ...
                this.isDirty("xAxis")) {
                    ...
                    if (e) {
                        const t = e.get("tooltip");
                        t && (this._tooltipX = !0,
                        this._disposers.push(t.on("pointTo", ( () => {
                            this._updateXLine(t)
                        }
                        ))))
                    }
            ...
            _updateChildren() {
                ...
                this.isDirty("positionX") || this.isDirty("positionY")) {
                    ...
                    null == e && null == t ? this.hide(0) : (this._movePoint = this.toGlobal(this._getPoint(this.get("positionX", 0), this.get("positionY", 0))),
                    this.handleMove())
                }
            }
            _updateXLine(e) {
            ...
            updateCursor() {
                this.get("alwaysShow") && (this._movePoint = this.toGlobal(this._getPoint(this.get("positionX", 0), this.get("positionY", 0)))),
                this.handleMove()
            }
            _setChart(e) {
                this.chart = e,
                ...
                this._setUpTouch()),
                this._disposers.push(t.events.on("pointerdown", (e => {
                ...
                this._disposers.push(t.events.on("globalpointermove", (e => {
                    (this.get("syncWith") || 0 != u.keys(t._downPoints).length || e.native || !this.isHidden()) && (this._handleMove(e),
                    Math.hypot(this._lastPoint2.x - e.point.x, this._lastPoint2.y - e.point.y) > 1 && (this._handleLineBlur(),
                    this._lastPoint2 = e.point))
                }
                )));
                const i = this.parent;
            ...
            _handleCursorUp(e) {
                if (this._downPoint) {
                    ...
                    if ("none" != t) {
                        ...
                        if (s && a) {
                            let i = !1;
                            if ("zoomX" !== t && "zoomXY" !== t && "selectX" !== t && "selectXY" !== t || Math.abs(s.x - a.x) > o && (i = !0),
                            "zoomY" !== t && "zoomXY" !== t && "selectY" !== t && "selectXY" !== t || Math.abs(s.y - a.y) > o && (i = !0),
                            i) {
                                const t = "selectended";
                                this.events.isEnabled(t) && this.events.dispatch(t, {
                                    type: t,
            ...
            handleMove(e, t, i) {
                ...
                if (o && (this._inPlot(a) || this._downPoint)) {
                    ...
                    l = p.y,
                    o.xAxes.each((e => {
                        e._handleCursorPosition(d, c),
                        s && e.handleCursorShow()
                    }
                    )),
                    o.yAxes.each((e => {
                        e._handleCursorPosition(m, c),
                        s && e.handleCursorShow()
                    }
                    )),
                    !t) {
            ...
            _updateSelection(e) {
                ...
                t.set("draw", (t => {
                    ...
                    o && ("zoomXY" === i || "selectXY" === i ? (t.moveTo(o.x, o.y),
                    t.lineTo(o.x, e.y),
                    t.lineTo(e.x, e.y),
                    t.lineTo(e.x, o.y),
                    t.lineTo(o.x, o.y)) : "zoomX" === i || "selectX" === i ? (t.moveTo(o.x, 0),
                    t.lineTo(o.x, a),
                    t.lineTo(e.x, a),
                    t.lineTo(e.x, 0),
                    t.lineTo(o.x, 0)) : "zoomY" !== i && "selectY" !== i || (t.moveTo(0, o.y),
                    t.lineTo(s, o.y),
                    t.lineTo(s, e.y),
                    t.lineTo(0, e.y),
                    t.lineTo(0, o.y)))
    ...
    6515: function(e, t, i) {
        ...
        class u extends s.w {
            ...
            _afterNew() {
                ...
                this._disposers.push(this.axisRanges.events.onAll((e => {
                    if ("clear" === e.type)
                ...
                if (this.get("zoomable", !0))
                    ...
                    this.get("start") !== e || this.get("end") != t) {
                        ...
                        let r = this.getPrivate("maxZoomFactor", this.get("maxZoomFactor", 100))
                          , l = r;
                        1 === t && 0 !== e && (s = e < this.get("start", 0) ? "start" : "end"),
                        0 === e && 1 !== t && (s = t > this.get("end", 1) ? "end" : "start");
                        let c = this.get("minZoomCount", 0)
                          , u = this.get("maxZoomCount", 1 / 0);
                        h.isNumber(c) && (r = l / c);
                        let d = 1;
                        if (h.isNumber(u) && (d = l / u),
                        "start" === s ? (u > 0 && 1 / (t - e) < d && (t = e + 1 / d),
                        1 / (t - e) > r && (t = e + 1 / r),
                        t > 1 && t - e < 1 / r && (e = t - 1 / r)) : (u > 0 && 1 / (t - e) < d && (e = t - 1 / d),
                        1 / (t - e) > r && (e = t - 1 / r),
                        e < 0 && t - e < 1 / r && (t = e + 1 / r)),
                        1 / (t - e) > r && (t = e + 1 / r),
                        1 / (t - e) > r && (e = t - 1 / r),
                        ...
                        if ((a && a.playing && a.to == e || this.get("start") == e) && (o && o.playing && o.to == t || this.get("end") == t))
                            return;
                        if (i > 0) {
            ...
            _prepareChildren() {
                if (super._prepareChildren(),
                this.get("fixAxisSize") ? this.ghostLabel.set("visible", !0) : this.ghostLabel.set("visible", !1),
                this.isDirty("start") || this.isDirty("end")) {
                    const e = this.chart;
                    e && e._updateCursor();
                    let t = this.get("start", 0)
                      , i = this.get("end", 1)
                      , s = this.get("maxDeviation", .5) * Math.min(1, i - t);
                    if (t < -s) {
                        let e = t + s;
                        t = -s,
                        this.setRaw("start", t),
                ...
                this.isDirty("tooltip")) {
                    ...
                    if (t) {
                        ...
                        t._applyThemes(),
                        i && (t.set("themeTags", c.mergeTags(t.get("themeTags"), i)),
            ...
            hideDataItem(e) {
                return this._toggleFHDataItem(e, !0),
                super.hideDataItem(e)
            }
            showDataItem(e) {
                return this._toggleFHDataItem(e, !1),
                super.showDataItem(e)
            }
            ...
            _createAssets(e, t, i) {
                ...
                if (l) {
                    let a = l.get("themeTags")
                      , o = !1;
                    i ? -1 == (null == a ? void 0 : a.indexOf(r)) && (o = !0) : -1 != (null == a ? void 0 : a.indexOf(r)) && (o = !0),
                    o && (null === (s = l.parent) || void 0 === s || s.children.removeValue(l),
                    n.makeLabel(e, t),
                    l.dispose(),
                ...
                if (h) {
                    let s = h.get("themeTags")
                      , o = !1;
                    i ? -1 == (null == s ? void 0 : s.indexOf(r)) && (o = !0) : -1 != (null == s ? void 0 : s.indexOf(r)) && (o = !0),
                    o && (null === (a = h.parent) || void 0 === a || a.children.removeValue(h),
                    n.makeGrid(e, t),
                    h.dispose(),
                ...
                if (c) {
                    let s = !1
                      , a = c.get("themeTags");
                    i ? -1 == (null == a ? void 0 : a.indexOf(r)) && (s = !0) : -1 != (null == a ? void 0 : a.indexOf(r)) && (s = !0),
                    s && (null === (o = c.parent) || void 0 === o || o.children.removeValue(c),
                    n.makeTick(e, t),
                    c.dispose(),
            ...
            _processBullet(e) {
                let t = e.get("bullet")
                  , i = this.get("bullet");
                if (t || !i || e.get("isRange") || (t = i(this._root, this, e)),
                t) {
                    t.axis = this;
            ...
            _afterChanged() {
                super._afterChanged();
                const e = this.chart;
                e && (e._updateChartLayout(),
                e.axisHeadersContainer.markDirtySize()),
            ...
            disposeDataItem(e) {
                ...
                const t = this.get("renderer")
                  , i = e.get("label");
                i && (t.labels.removeValue(i),
                i.dispose());
                const s = e.get("tick");
                s && (t.ticks.removeValue(s),
                s.dispose());
                const a = e.get("grid");
                a && (t.grid.removeValue(a),
                a.dispose());
                const o = e.get("axisFill");
                o && (t.axisFills.removeValue(o),
                o.dispose());
            ...
            updateTooltip() {
                ...
                h.isNumber(t) && (l.each(this.series, (i => {
                    if (i.get("baseAxis") === this) {
                        ...
                        e && -1 != e.indexOf(i) ? (i.updateLegendMarker(s),
                        i.updateLegendValue(s),
                        i._settings.tooltipDataItem = s) : (i.showDataItemTooltip(s),
                        i.setRaw("tooltipDataItem", s))
                    }
                }
                )),
                this.get("snapTooltip") && (t = this.roundAxisPosition(t, this.get("tooltipLocation", .5))),
                this.setPrivateRaw("tooltipPosition", t),
                i && (s.updateTooltipBounds(i),
                h.isNaN(t) ? i.hide(0) : (this._updateTooltipText(i, t),
                s.positionTooltip(i, t),
                t < this.get("start", 0) || t > this.get("end", 1) ? i.hide(0) : i.show(0))))
            }
    ...
    6275: function(e, t, i) {
        ...
        class c extends s.T {
            ...
            makeLabel(e, t) {
                ...
                return i.set("themeTags", h.mergeTags(i.get("themeTags"), t)),
            ...
            _beforeChanged() {
                super._beforeChanged(),
                this.isDirty("minGridDistance") && this.root.events.once("frameended", ( () => {
            ...
            toGlobalPosition(e) {
                const t = this._start || 0
                  , i = this._end || 1;
                return this.get("inversed") ? e = i - e : e -= t,
                e / (i - t)
            }
            fixPosition(e) {
            ...
            _positionTooltip(e, t) {
                const i = this.chart;
                i && (e.set("pointTo", this._display.toGlobal(t)),
                i.inPlot(t) || e.hide())
            }
            processAxis() {}
        }
    ...
    6284: function(e, t, i) {
        ...
        class l extends s.Y {
            ...
            _afterNew() {
                this._settings.themeTags = n.mergeTags(this._settings.themeTags, ["renderer", "x"]),
                super._afterNew(),
            ...
            _changed() {
                ...
                if (this.isDirty(t) || this.isDirty(i)) {
                    const s = this.chart
                      , a = e.children;
                    if (this.get(i) ? e.addTag(i) : e.removeTag(i),
                    s) {
                        if (this.get(t)) {
            ...
            toAxisPosition(e) {
                const t = this._start || 0
                  , i = this._end || 1;
                return e = (e -= this._ls) * (i - t) / this._lc,
                this.get("inversed") ? i - e : t + e
            }
            toGlobalPosition(e) {
                const t = this._start || 0
            ...
            _updatePositions() {
                ...
                if (i) {
                    ...
                    s.children.length > 0 ? (a = e.axisHeader.width(),
                    e.set("marginLeft", a + 1)) : s.set("width", a),
                    s.setAll({
                        x: o,
                        y: -1,
                        height: t.height() + 2
            ...
            updateLabel(e, t, i, s) {
                if (e) {
                    ...
                    this.get("opposite") ? r ? (e.set("position", "absolute"),
                    e.set("y", 0)) : (e.set("position", "relative"),
                    e.set("y", a.AQ)) : r ? (e.set("y", 0),
                    e.set("position", "absolute")) : (e.set("y", void 0),
            ...
            updateTooltipBounds(e) {
                ...
                const c = {
                  ...
                  , u = e.get("bounds");
                n.sameBounds(c, u) || (e.set("bounds", c),
                e.set("pointerOrientation", h))
            }
        }
    ...
    7909: function(e, t, i) {
        ...
        class l extends s.Y {
            ...
            _afterNew() {
                this._settings.themeTags = n.mergeTags(this._settings.themeTags, ["renderer", "y"]),
            ...
            _changed() {
                ...
                if (this.isDirty(i) || this.isDirty(s)) {
                    const t = e.children;
                    if (this.get(s) ? e.addTag(s) : e.removeTag(s),
                    a) {
                        if (this.get(i)) {
            ...
            _updatePositions() {
                ...
                if (i) {
                    ...
                    s.children.length > 0 ? (a = e.axisHeader.height(),
                    e.set("marginTop", a + 1)) : s.set("height", a),
                    s.setAll({
                        y: e.y() - a,
                        x: -1,
                        width: t.width() + 2
            ...
            updateLabel(e, t, i, s) {
                if (e) {
                    ...
                    n ? (e.set("x", 0),
                    r ? e.set("position", "absolute") : e.set("position", "relative")) : r ? (e.set("x", 0),
                    e.set("position", "absolute")) : (e.set("x", void 0),
                    e.set("position", "relative")),
                    o.isNumber(i) && i != t && (t += (i - t) * a),
            ...
            toGlobalPosition(e) {
                const t = this._start || 0
                  , i = this._end || 1;
                return this.get("inversed") ? e -= t : e = i - e,
                (e = e / (i - t) * this._lc) + this._ls
            }
            fixPosition(e) {
        ...
        class d extends a.m {
            ...
            _groupData() {
                ...
                if (o.isNumber(e) && o.isNumber(t)) {
                    ...
                    if (e ? this._setBaseInterval(e) : this._setBaseInterval(this.get("baseInterval")),
            ...
            _groupSeriesData(e) {
                if (this.get("groupData") && !e.get("groupDataDisabled")) {
                    ...
                    p && (b = !0),
                    l.each(t, (t => {
                        let i, a = -1 / 0, c = t.timeUnit + t.count;
                        e._dataSets[c] = [];
                        let g = {}
                          , m = {}
                          , _ = {}
                        ...
                        let v, f, y = u.getDuration(t.timeUnit);
                        d[0] && (v = d[0].get(n)),
                        l.each(d, (d => {
                            let P, w = d.get(n), D = u.roun(w, t.timeUnit, t.count, this._root, v);
                            a < D - y / 24 ? (P = h.copy(d.dataContext),
                            i = new s.z(e,P,e._makeDataItem(P)),
                            i.setRaw(n, D),
                            e._dataSets[c].push(i),
                            l.each(r, (e => {
                                let t = d.get(e);
                                o.isNumber(t) ? (i.setRaw(e, t),
                                i.setRaw(x[e], t),
                                m[e] = 1,
                                g[e] = t) : (g[e] = 0,
                                m[e] = 0)
                    ...
                    this.markDirtySize(),
                    this._seriesAdded && this._root.events.once("frameended", ( () => {
                        this.markDirtySize()
                    }
                    ))
                }
            ...
            getGroupInterval(e) {
                ...
                return u.getIntervalDuration(i) < u.getIntervalDuration(t) && (i = Object.assign({}, t)),
                i
            }
            getIntervalMax(e) {
            ...
            _handleRangeChange() {
                ...
                if (o.isNumber(e) && o.isNumber(t)) {
                    ...
                    this.get("groupData") && !this._groupingCalculated) {
                        ...
                        if (i || (i = this.getGroupInterval(a)),
                        i && (!s || s.timeUnit !== i.timeUnit || s.count !== i.count || this._seriesDataGrouped)) {
            ...
            _saveMinMax(e, t) {
                ...
                this._intervalMin[s] = e,
                this._intervalMax[s] = t
            }
            _getM(e) {
            ...
            _getMinorInterval(e) {
                var t;
                let i, s = e.count, a = e.timeUnit;
                return s > 1 && (10 == s || 15 == s ? s = 5 : 12 == s ? s = 2 : 6 == s ? s = 1 : 30 == s ? s = 10 : s < 10 && (s = 1),
                i = {
                    timeUnit: a,
                    count: s
                }),
                "week" == a && "week" != (null === (t = this.getPrivate("baseInterval")) || void 0 === t ? void 0 : t.timeUnit) && (i = {
                    timeUnit: "day",
                    count: 1
                }),
                i
            ...
            _prepareAxisItems() {
                ...
                if (o.isNumber(e) && o.isNumber(t)) {
                    ...
                    let w, D = 0;
                    P && (w = this._getMinorInterval(g),
                    D = u.getIntervalDuration(w));
                    let T = 0;
                    for (; h < a + m; ) {
                        let e;
                        this.dataItems.length < c + 1 ? (e = new s.z(this,void 0,{}),
                        this._dataItems.push(e),
                        this.processDataItem(e)) : e = this.dataItems[c],
                        ...
                        i = u.roun(i, g.timeUnit, 1, t),
                        e.setRaw("endValue", i);
                        let a = new Date(h);
                        x = f[g.timeUnit],
                        p && this.get("markUnitChange") && o.isNumber(v) && "year" != g.timeUnit && u.checkChange(h, v, p, b, _) && (x = this.get("periodChangeDateFormats")[g.timeUnit]);
                        const n = e.get("label");
                        n && n.set("text", t.dateFormatter.format(a, x));
                        let r = g.count;
                        if ("week" == g.timeUnit && e.setRaw("labelEndValue", h),
                        P) {
                            r = 1;
                            let i = g.timeUnit;
                            "week" == i && (i = "day");
                            ...
                            s = u.roun(s, i, 1, t),
                            e.setRaw("labelEndValue", s)
                        }
                        if (this._prepareDataItem(e, r),
                        v = h,
                        h = i,
                        w) {
                            const e = w.timeUnit
                              , i = w.count
                              , a = this._getM(e);
                            let o, n = u.roun(v + D * a, e, i, t, v), r = this.get("minorDateFormats", this.get("dateFormats"));
                            for (; n < h - .01 * D; ) {
                                let l;
                                this.minorDataItems.length < T + 1 ? (l = new s.z(this,void 0,{}),
                                this.minorDataItems.push(l),
                                this.processDataItem(l)) : l = this.minorDataItems[T],
                                ...
                                x = r[e];
                                const d = l.get("label");
                                if (d && (y ? d.set("text", t.dateFormatter.format(c, x)) : d.setPrivate("visible", !1)),
            ...
            _fixMin(e) {
                ...
                return a = u.roun(a, i, 1, this._root),
            ...
            getDataItemPositionX(e, t, i, s) {
                let a, o;
                e.open && e.close ? (a = e.open[t],
                o = e.close[t]) : (a = e.get(t),
                o = a);
                let n = a + (o - a) * i;
                return n = this._baseValue + (n - this._baseValue) * s,
            ...
            roundAxisPosition(e, t) {
                ...
                if (!o.isNaN(i)) {
                    ...
                    return n && (i = u.roun(i + .05 * this.baseDuration(), a, r, this._root, this.getPrivate("min", 0)),
                    l = u.getDateIntervalDuration(s, new Date(i + l * t), e, o, n)),
            ...
            getTooltipText(e, t) {
                if (null != this.getPrivate("min")) {
                    ...
                    if (o.isNumber(s)) {
                        ...
                        return !1 !== t && (e = new Date(s + this.get("tooltipIntervalOffset", -this.get("tooltipLocation", .5)) * o)),
                        this._root.dateFormatter.format(e, this.get("tooltipDateFormat", i))
                    }
                }
                return ""
            }
            getSeriesItem(e, t, i, s) {
                ...
                null == i && (i = .5),
                o -= (i - .5) * this.baseDuration();
                const n = l.getSortedIndex(e.dataItems, (e => {
                    let t = 0;
                    return e.open && (t = e.open[a]),
                    r.qu(t, o)
                }
                ));
            ...
            nextPosition(e) {
                null == e && (e = 1);
                let t = this.get("tooltipLocation", .5) * this.baseDuration();
        ...
        class c extends s.S {
            ...
            valueToPosition(e) {
                    ...
                    return (l - i) / a;
                {
                    ...
                    let s = t[l]
                      , o = 0;
                    return o = s > e && e > this.getPrivate("min", 0) ? s - e : e - s,
                    (l - i) / a + o / this.baseDuration() / a
                }
            }
            valueToIndex(e) {
                const t = this._getDates()
            ...
            _prepareAxisItems() {
                ...
                if (l.isNumber(e) && l.isNumber(t)) {
                    this._seriesValuesDirty && (this._seriesValuesDirty = !1,
                    ...
                    f < d && (x = Object.assign({}, v),
                    f = r.getIntervalDuration(x)),
                    ...
                    let I, k, M = 0;
                    A && (I = this._getMinorInterval(x),
                    M = r.getIntervalDuration(I));
                    ...
                    if (O.length > 0) {
                        ...
                        let d = c.axisLength() / c.gridCount() * .5;
                        o.each(O, (o => {
                            var g;
                            let m;
                            this.dataItems.length < e + 1 ? (m = new a.z(this,void 0,{}),
                            this._dataItems.push(m),
                            this.processDataItem(m)) : m = this.dataItems[e];
                            let p = h[o]
                              , b = new Date(p)
                              , _ = p;
                            ...
                            let v = P[y];
                            u && this.get("markUnitChange") && l.isNumber(t) && "year" != y && r.checkChange(p, t, u, s, n) && (v = this.get("periodChangeDateFormats")[y]),
                            this._createAssets(m, []);
                            const w = m.get("label");
                            w && w.set("text", i.dateFormatter.format(b, v)),
                            this._toggleDataItem(m, !0);
                            let D = x.count;
                            if ("week" == y && m.setRaw("labelEndValue", p),
                            A) {
                                let e = x.timeUnit;
                                if ("week" == e && (e = "day"),
                                D > 1 || "week" == x.timeUnit) {
            ...
            _addMinorGrid(e, t, i, s) {
                ...
                o.each(u, (e => {
                    let t;
                    this.minorDataItems.length < this._m + 1 ? (t = new a.z(this,void 0,{}),
                    this.minorDataItems.push(t),
                    this.processDataItem(t)) : t = this.minorDataItems[this._m],
                    h = d[e],
                    t.setRaw("value", h),
    ...
    7261: function(e, t, i) {
        ...
        class c extends a.R {
            ...
            _prepareChildren() {
                ...
                let e = !1;
                if ((this.isDirty("min") || this.isDirty("max") || this.isDirty("maxPrecision") || this.isDirty("numberFormat")) && (e = !0,
                this.ghostLabel.set("text", "")),
                (this._sizeDirty || this._dirtyExtremes || this._valuesDirty || e || this.isPrivateDirty("width") || this.isPrivateDirty("height") || this.isDirty("extraMin") || this.isDirty("extraMax") || this.isDirty("logarithmic") || this.isDirty("treatZeroAs") || this.isDirty("baseValue") || this.isDirty("strictMinMax") || this.isDirty("strictMinMaxSelection")) && (this._getMinMax(),
                ...
                this._groupData(),
                (this._sizeDirty || this._valuesDirty || this.isDirty("start") || this.isDirty("end") || this.isPrivateDirty("min") || this.isPrivateDirty("selectionMax") || this.isPrivateDirty("selectionMin") || this.isPrivateDirty("max") || this.isPrivateDirty("step") || this.isPrivateDirty("width") || this.isPrivateDirty("height") || this.isDirty("logarithmic")) && (this._handleRangeChange(),
            ...
            _formatText(e) {
                ...
                let s = "";
                return s = t ? i.format(e, t) : i.format(e, void 0, this.getPrivate("stepDecimalPlaces")),
                s
            }
            _prepareAxisItems() {
                const e = this.getPrivate("min")
                ...
                if (n.isNumber(e) && n.isNumber(t)) {
                    ...
                    let h = a - i
                      ...
                      , u = e;
                    if (t) {
                        if (h = this._minLogAdjusted,
                        h < a)
                            for (; h < a; )
                                h += i;
                        u = h,
                        u <= 0 && (u = 1,
                        i < 1 && (u = n.isNumber(this._minRealLog) ? this._minRealLog : Math.pow(10, -50))),
                    ...
                    for (; h < o; ) {
                        let e;
                        this.dataItems.length < v + 1 ? (e = new s.z(this,void 0,{}),
                        this._dataItems.push(e),
                        this.processDataItem(e)) : e = this.dataItems[v],
                        this._createAssets(e, []),
                        this._toggleDataItem(e, !0),
                        e.setRaw("value", h);
                        const a = e.get("label");
                        a && a.set("text", this._formatText(h)),
                        this._prepareDataItem(e);
                        let o = h;
                        if (t && c > 2 ? o = Math.pow(10, Math.log(u) * Math.LOG10E + v - 50) : o += i,
                        m) {
                            let e = h + x;
                            for (t && (c > 2 && (x = this._adjustMinMax(h, o, 10).step),
                            e = h + x); e < o - 1e-11 * i; ) {
                                let t;
                                this.minorDataItems.length < f + 1 ? (t = new s.z(this,void 0,{}),
                                this.minorDataItems.push(t),
                                this.processDataItem(t)) : t = this.minorDataItems[f],
                                this._createAssets(t, ["minor"], !0),
                                this._toggleDataItem(t, !0),
                                t.setRaw("value", e);
                                const i = t.get("label");
                                i && (g ? i.set("text", this._formatText(e)) : i.setPrivate("visible", !1)),
            ...
            _prepareDataItem(e, t) {
                ...
                n.isNumber(a) && (r = this.valueToPosition(a),
                l = r),
                ...
                const u = e.get("grid");
                if (i.updateGrid(u, o, r),
                u && (s == this.get("baseValue", 0) ? (u.addTag("base"),
                u._applyThemes()) : u.hasTag("base") && (u.removeTag("base"),
                u._applyThemes())),
            ...
            _handleRangeChange() {
                ...
                e = s.min,
                t = s.max,
                this.getPrivate("selectionMin") === e && this.getPrivate("selectionMax") === t && this.getPrivate("step") === o || (this.setPrivateRaw("selectionMin", e),
            ...
            getDataItemPositionX(e, t, i, s) {
                let a = e.get(t);
                return a = e.get("stackToItemX") ? a * s + e.component.getStackedXValueWorking(e, t) : this._baseValue + (a - this._baseValue) * s,
            ...
            getDataItemPositionY(e, t, i, s) {
                let a = e.get(t);
                return a = e.get("stackToItemY") ? a * s + e.component.getStackedYValueWorking(e, t) : this._baseValue + (a - this._baseValue) * s,
                this.valueToPosition(a)
            }
            basePosition() {
                ...
                if (this.get("calculateTotals")) {
                    ...
                    if (e) {
                        ...
                        if (e.dataItems.length > 0) {
                            ...
                            e.get("yAxis") == this ? (i = "valueY",
                            s = "vcy") : e.get("xAxis") == this && (i = "valueX",
                            s = "vcx");
                            let o = i + "Working";
                            if (i)
                                for (let e = t; e < a; e++) {
            ...
            _getSelectionMinMax() {
                ...
                this.get("logarithmic") && (null == this.get("extraMin") && (a = .1),
                null == this.get("extraMax") && (o = .2));
                ...
                if (n.isNumber(e) && n.isNumber(t)) {
                    ...
                    if (r.each(this.series, (e => {
                        if (!e.get("ignoreMinMax")) {
                            ...
                            if (e.get("xAxis") === this) {
                                if (!s) {
                                    let s = e.getPrivate("minX")
                                      , a = e.getPrivate("maxX");
                                    0 == e.startIndex() && e.endIndex() == e.dataItems.length || (s = void 0,
                                    a = void 0),
                            ...
                            e.isHidden() || e.isShowing() || (n.isNumber(t) && (d = Math.min(d, t)),
                    ...
                    b = this._adjustMinMax(d, g, h, !0),
                    u || (d = b.min,
                    g = b.max);
                    const _ = this.get("syncWithAxis");
                    _ && (b = this._syncAxes(d, g, b.step, _.getPrivate("selectionMinFinal", _.getPrivate("minFinal", 0)), _.getPrivate("selectionMaxFinal", _.getPrivate("maxFinal", 1)), _.getPrivate("selectionStepFinal", _.getPrivate("step", 1))),
                    b.min < e && (b.min = e),
                    b.max > t && (b.max = t),
                    d = b.min,
                    g = b.max),
                    u && (n.isNumber(i) && (d = Math.max(d, i)),
                    n.isNumber(s) && (g = Math.min(g, s))),
                    c && (d = m - (p - m) * a,
                    g = p + (p - m) * o),
                    this.get("logarithmic") && (d <= 0 && (d = m * (1 - Math.min(a, .99))),
                    d < e && (d = e),
                    g > t && (g = t));
                    ...
                    this.setPrivateRaw("selectionStepFinal", b.step),
                    this.zoom(v, f)
                }
            }
            _getMinMax() {
                ...
                if (r.each(this.series, (e => {
                    if (!e.get("ignoreMinMax")) {
                        let t, a;
                        if (e.get("xAxis") === this ? (t = e.getPrivate("minX"),
                        a = e.getPrivate("maxX")) : e.get("yAxis") === this && (t = e.getPrivate("minY"),
                        a = e.getPrivate("maxY")),
                        n.isNumber(t) && n.isNumber(a)) {
                            i = Math.min(i, t),
                            s = Math.max(s, a);
                            let e = a - t;
                            e <= 0 && (e = Math.abs(a / 100)),
                            e < h && (h = e)
                        }
                    }
                }
                ...
                this.get("logarithmic")) {
                    ...
                    i <= 0 && new Error("Logarithmic value axis can not have values <= 0.")
                }
                if (0 === i && 0 === s && (s = .9,
                i = -.9),
                n.isNumber(e) && (i = e),
                n.isNumber(t) && (s = t),
                i === 1 / 0 || s === -1 / 0)
                    return this.setPrivate("minFinal", void 0),
                ...
                i = this._fixMin(i),
                s = this._fixMax(s),
                s - i <= 1 / Math.pow(10, 15) && (s - i != 0 ? this._deltaMinMax = (s - i) / 2 : this._getDelta(s),
                i -= this._deltaMinMax,
                s += this._deltaMinMax),
                i -= (s - i) * a,
                s += (s - i) * o,
                this.get("logarithmic") && (i < 0 && c >= 0 && (i = 0),
                s > 0 && u <= 0 && (s = 0)),
                this._minReal = i,
                this._maxReal = s;
                ...
                i = x.min,
                s = x.max,
                m && (i = n.isNumber(e) ? e : this._minReal,
                s = n.isNumber(t) ? t : this._maxReal,
                s - i <= 1e-8 && (i -= this._deltaMinMax,
                s += this._deltaMinMax),
                i -= (s - i) * a,
                s += (s - i) * o),
                ...
                if (f && (x = this._syncAxes(i, s, x.step, f.getPrivate("minFinal", f.getPrivate("min", 0)), f.getPrivate("maxFinal", f.getPrivate("max", 1)), f.getPrivate("step", 1)),
                i = x.min,
                s = x.max),
                this.setPrivateRaw("maxZoomFactor", Math.max(1, Math.ceil((s - i) / h * this.get("maxZoomFactor", 100)))),
                this._fixZoomFactor(),
                this.get("logarithmic") && (this._minLogAdjusted = i,
                i = this._minReal,
                s = this._maxReal,
                i <= 0 && (i = c * (1 - Math.min(a, .99)))),
            ...
            _adjustMinMax(e, t, i, s) {
                ...
                let u = c;
                s && (u = 0),
                s ? (e = Math.floor(e / c) * c,
                t = Math.ceil(t / c) * c) : (e = Math.ceil(e / c) * c - u,
                ...
                let b = 0;
                g < 1 && (b = Math.round(Math.abs(Math.log(Math.abs(g)) * Math.LOG10E)) + 1,
                d = l.round(d, b));
                let _, x = Math.floor(e / d);
                return e = l.round(d * x, b),
            ...
            getSeriesItem(e, t) {
                let i, s, a = this.getPrivate("name") + this.get("renderer").getPrivate("letter"), o = this.positionToValue(t);
            ...
            nextPosition(e) {
                ...
                return t += this.getPrivate("step", 1) * e,
                t = l.fitToRange(t, this.getPrivate("selectionMin", 0), this.getPrivate("selectionMax", 1)),
    ...
    757: function(e, t, i) {
        ...
        class h extends a.o {
            ...
            _updateChildren() {
                const e = this.chart;
                e && (this._ph = e.plotContainer.height(),
                this._pw = e.plotContainer.width());
                const t = this.get("xAxis")
                  , i = this.get("yAxis")
                  , s = this.get("baseAxis")
                  , a = this.columns.template;
                this.isDirty("fill") && null == a.get("fill") && a.set("fill", this.get("fill")),
                this.isDirty("stroke") && null == a.get("stroke") && a.set("stroke", this.get("stroke"));
                let o = 0
                  , n = 0
                  , l = 0;
                r.each(s.series, (e => {
                ...
                const c = t.get("renderer")
                  ...
                  , b = u.get(d, 0)
                  , _ = u.get(g, 1);
                if (this._aLocationX0 = m + o / n * (p - m),
            ...
            createAxisRange(e) {
                return r.each(this.dataItems, (e => {
                    const t = e.get("graphics");
                    t && (t.dispose(),
                    e.set("graphics", void 0))
                }
                )),
            ...
            _updateGraphics(e, t) {
                ...
                if (null != n && null != h) {
                    const n = this._xOpenField
                      ...
                      , P = x.get("start")
                      , w = x.get("end");
                    let D, T, A, I, k = this.get("vcy", 1), M = this.get("vcx", 1), O = !1, C = !1;
                    if (x.isType("CategoryAxis") && _.isType("CategoryAxis")) {
                        ...
                        if (D = _.getDataItemPositionX(e, n, t, M),
                        T = _.getDataItemPositionX(e, s, i, M),
                        t = this._aLocationY0 + g - .5,
                        ...
                        if (A = x.getDataItemPositionY(e, h, t, k),
                        I = x.getDataItemPositionY(e, a, i, k),
                    ...
                    D < f && T < f || D > y && T > y || A < P && I <= P || A >= w && I > w || l.isNaN(D) || l.isNaN(A) ? this._toggleColumn(e, !1) : this._toggleColumn(e, !0);
            ...
            _updateSeriesGraphics(e, t, i, s, a, o, n, r) {
                ...
                this.get("adjustBulletPosition") && (n && (s = Math.min(Math.max(0, s), this._pw),
                i = Math.min(Math.max(0, i), this._pw)),
                r && (a = Math.min(Math.max(0, a), this._ph),
            ...
            _applyGraphicsStates(e, t) {
                ...
                if (s || o || a || n) {
                    const i = this.get("xAxis")
                      ...
                      , h = this.get("baseAxis");
                    let c, u, d;
                    h === i && r.isType("ValueAxis") ? (c = e.get(this._yOpenField),
                    u = e.get(this._yField),
                    d = t.get(this._yField)) : h === r && i.isType("ValueAxis") && (c = e.get(this._xOpenField),
                    u = e.get(this._xField),
                    d = t.get(this._xField)),
                    l.isNumber(c) && l.isNumber(u) && (u < c ? s && s.apply() : a && a.apply(),
    ...
    2312: function(e, t, i) {
        ...
        class h extends s.d {
            ...
            _updateGraphics(e, t) {
                ...
                let o, n, r, l, h, c, u, d, g, m = this.get("vcy", 1), p = this.get("vcx", 1), b = this.get("locationX", e.get("locationX", .5)), _ = this.get("locationY", e.get("locationY", .5)), x = this.get("openLocationX", e.get("openLocationX", b)), v = this.get("openLocationY", e.get("openLocationY", _));
                if (s === a) {
            ...
            _processAxisRange(e) {
                ...
                e.columns = new n.o(o.YS.new({}),( () => a.j._new(this._root, {
    ...
    62: function(e, t, i) {
        ...
        class l extends s.d {
            ...
            _processAxisRange(e) {
                super._processAxisRange(e),
                e.columns = new o.o(a.YS.new({}),( () => n.c._new(this._root, {
                    position: "absolute",
        ...
        class p extends s.o {
            ...
            _updateChildren() {
                ...
                if (this.isDirty("curveFactory")) {
                    ...
                    e && (this._strokeGenerator.curve(e),
                    this._fillGenerator.curve(e))
                }
                if (e.inited && t.inited) {
            ...
            _startSegment(e) {
                ...
                for (X = e; X < i; X++) {
                    ...
                    let n = t.get(b)
                      , l = t.get(_);
                    if (null == n || null == l ? a || (I = [],
                    A.push(I),
                    R.points = I) : this._getPoints(t, R),
                    k) {
                        let s = t.dataContext[k];
                        if (s) {
                            if (s instanceof r.YS || (s = r.YS.new(s)),
            ...
            _getPoints(e, t) {
                ...
                if (this._shouldInclude(o)) {
                    ...
                    t.fillVisible) {
                        let i = o
                          , s = n;
                        if (t.baseAxis === t.xAxis ? s = t.basePosY : t.baseAxis === t.yAxis && (i = t.basePosX),
                        t.getOpen) {
                            ...
                            if (null != a && null != o) {
                                ...
                                if (t.stacked) {
                                    ...
                                    n ? (i = t.xAxis.getDataItemPositionX(n, t.xField, a, n.component.get("vcx")),
                                    d.isNaN(i) && (i = t.basePosX)) : i = t.yAxis === t.baseAxis ? t.basePosX : t.xAxis.getDataItemPositionX(e, t.xOpenField, a, t.vcx),
                                    r ? (s = t.yAxis.getDataItemPositionY(r, t.yField, o, r.component.get("vcy")),
                                    d.isNaN(s) && (s = t.basePosY)) : s = t.xAxis === t.baseAxis ? t.basePosY : t.yAxis.getDataItemPositionY(e, t.yOpenField, o, t.vcy)
                                } else
                                    i = t.xAxis.getDataItemPositionX(e, t.xOpenField, a, t.vcx),
                                    s = t.yAxis.getDataItemPositionY(e, t.yOpenField, o, t.vcy)
                            }
                        }
                    ...
                    if (t.minDistance > 0) {
                        const e = a[0]
                          ...
                          , c = r[2]
                          , u = r[3];
                        (Math.hypot(e - l, s - h) > t.minDistance || o && n && Math.hypot(o - c, n - u) > t.minDistance) && (i.push(a),
                        this._previousPoint = a)
                    } else
                        i.push(a)
                }
            }
            ...
            _drawStroke(e, t) {
                e.get("visible") && !e.get("forceHidden") && e.set("draw", (e => {
                    g.each(t, (t => {
                        this._strokeGenerator.context(e),
                        this._strokeGenerator(t)
                    }
                    ))
                }
                ))
            ...
            _drawFill(e, t) {
                e.get("visible") && !e.get("forceHidden") && e.set("draw", (e => {
                    g.each(t, (t => {
                        this._fillGenerator.context(e),
                        this._fillGenerator(t)
                    }
                    ))
                }
                ))
            ...
            createLegendMarker(e) {
                ...
                if (t) {
                    ...
                    e.set("background", u.A.new(e._root, {
                        fillOpacity: 0,
                        fill: (0,
                        h.$_)(0)
                    }));
        ...
        class g extends o.F {
            ...
            _removeAxisRange(e) {
                const t = e.axisDataItem
                  , i = t.component;
                i.disposeDataItem(t),
                u.remove(i._seriesAxisRanges, t);
                const s = e.container;
                s && s.dispose()
            }
            _updateFields() {
                ...
                this.valueXFields && u.each(this.valueXFields, (e => {
                    if (this.get(e + "Field")) {
                        this._valueXFields.push(e);
                        let t = this.get(e + "Show");
                        this.__valueXShowFields.push(t),
                        -1 != t.indexOf("Working") ? this._valueXShowFields.push(t.split("Working")[0]) : this._valueXShowFields.push(t)
                    }
                }
                )),
                this.valueYFields && u.each(this.valueYFields, (e => {
                    if (this.get(e + "Field")) {
                        ...
                        -1 != t.indexOf("Working") ? this._valueYShowFields.push(t.split("Working")[0]) : this._valueYShowFields.push(t)
                    }
                }
                ))
            }
            ...
            _min(e, t) {
                let i = (a = t,
                null == (s = this.getPrivate(e)) ? a : null == a ? s : a < s ? a : s);
                var s, a;
                this.setPrivate(e, i)
            }
            _max(e, t) {
            ...
            _shouldMakeBullet(e) {
                ...
                if (a > 0) {
                    let e = this.startIndex()
                      , o = this.endIndex() - e;
                    if (t == s) {
                        if (t.get("renderer").axisLength() / o < a / 5)
                            return !1
            ...
            _makeFieldNames() {
                const e = this.get("xAxis")
                  ...
                  , c = "high"
                  , u = "Show";
                "ValueAxis" === e.className ? (this._xField = this.get(i + n + u),
                this._xOpenField = this.get(l + s + n + u),
                this._xLowField = this.get(h + s + n + u),
                this._xHighField = this.get(c + s + n + u)) : (this._xField = i + n,
                this._xOpenField = l + s + n,
                this._xLowField = h + s + n,
                this._xHighField = c + s + n),
                "ValueAxis" === t.className ? (this._yField = this.get(a + r + u),
                this._yOpenField = this.get(l + o + r + u),
                this._yLowField = this.get(h + o + r + u),
                this._yHighField = this.get(c + o + r + u)) : (this._yField = a + r,
            ...
            _fixVC() {
                ...
                if (s) {
                    let o = 0;
                    a && (o = .999999999999),
                    e === i ? s.set("vcy", o) : (t === i || s.set("vcy", o),
                    s.set("vcx", o))
                }
            }
            _handleMaskBullets() {
            ...
            _prepareChildren() {
                super._prepareChildren(),
                this._bullets = {},
                (this.isDirty("valueYShow") || this.isDirty("valueXShow") || this.isDirty("openValueYShow") || this.isDirty("openValueXShow") || this.isDirty("lowValueYShow") || this.isDirty("lowValueXShow") || this.isDirty("highValueYShow") || this.isDirty("highValueXShow")) && (this._updateFields(),
                this._makeFieldNames(),
                this._valuesDirty = !0),
                ...
                switch (this._tooltipFieldX = s,
                this.get("tooltipPositionY")) {
                case "open":
                    a = this._yOpenField;
                    break;
                case "low":
                ...
                if (this.isDirty("stacked") && (o ? this._valuesDirty && !this._dataProcessed || this._stack() : this._unstack()),
                this._valuesDirty && !this._dataProcessed && (this._dataProcessed = !0,
                o && this._stack(),
                u.each(this.dataItems, (i => {
                    u.each(this._valueXShowFields, (e => {
                        let t = i.get(e);
                        null != t && (o && (t += this.getStackedXValue(i, e)),
                        this._min("minX", t),
                        this._max("maxX", t))
                    }
                    )),
                    u.each(this._valueYShowFields, (e => {
                        let t = i.get(e);
                        null != t && (o && (t += this.getStackedYValue(i, e)),
                        this._min("minY", t),
                        this._max("maxY", t))
                    }
                    )),
                ...
                this.get("ignoreMinMax") || ((this.isPrivateDirty("minX") || this.isPrivateDirty("maxX")) && e.markDirtyExtremes(),
                (this.isPrivateDirty("minY") || this.isPrivateDirty("maxY")) && t.markDirtyExtremes()),
                this._markStakedDirtyStack(),
                this.get("tooltipDataItem") || this.updateLegendValue(void 0)),
                (this.isDirty("vcx") || this.isDirty("vcy")) && this._markStakedDirtyStack(),
                this._dataGrouped || (e._groupSeriesData(this),
                ...
                this._valuesDirty || this.isPrivateDirty("startIndex") || this.isPrivateDirty("adjustedStartIndex") || this.isPrivateDirty("endIndex") || this.isDirty("vcx") || this.isDirty("vcy") || this._stackDirty || this._sizeDirty) {
                    ...
                    if (o > 0 && i && (i.get("renderer").axisLength() / (a - s) > o ? this._showBullets = !0 : this._showBullets = !1),
                    (this._psi != s || this._pei != a || this.isDirty("vcx") || this.isDirty("vcy") || this.isPrivateDirty("adjustedStartIndex") || this._stackDirty || this._valuesDirty) && !this._selectionProcessed) {
                        ...
                        if ((i === e || !i) && "valueYWorking" !== this.get("valueYShow")) {
                            ...
                            null != e && (this.setPrivateRaw("minY", e),
                            t.markDirtyExtremes());
                            const i = this.getPrivate("selectionMaxY");
                            null != i && (this.setPrivateRaw("maxY", i),
                            t.markDirtyExtremes())
                        }
                        if ((i === t || !i) && "valueXWorking" !== this.get("valueXShow")) {
                            const i = this.getPrivate("selectionMinX");
                            null != i && (this.setPrivateRaw("minX", i),
                            t.markDirtyExtremes());
                            const s = this.getPrivate("selectionMaxX");
                            null != s && (this.setPrivateRaw("maxX", s),
                            e.markDirtyExtremes())
                        }
                        (this.isPrivateDirty("selectionMinX") || this.isPrivateDirty("selectionMaxX")) && e.markDirtySelectionExtremes(),
                        (this.isPrivateDirty("selectionMinY") || this.isPrivateDirty("selectionMaxY")) && t.markDirtySelectionExtremes()
                    }
                }
            }
            _makeRangeMask() {
                if (this.axisRanges.length > 0) {
                    ...
                    null == e && (e = this.children.push(l.T.new(this._root, {})),
            ...
            _stack() {
                ...
                if (e) {
                    ...
                    if (this._couldStackTo = [],
                    t > 0) {
                        let i;
                        for (let s = t - 1; s >= 0 && (i = e.series.getIndex(s),
                        i.get("xAxis") !== this.get("xAxis") || i.get("yAxis") !== this.get("yAxis") || i.className !== this.className || (this._couldStackTo.push(i),
                        i.get("stacked"))); s--)
                            ;
                    }
            ...
            processXSelectionDataItem(e, t, i) {
                u.each(this.__valueXShowFields, (s => {
                    let a = e.get(s);
                    null != a && (i && (a += this.getStackedXValueWorking(e, s)),
            ...
            processYSelectionDataItem(e, t, i) {
                u.each(this.__valueYShowFields, (s => {
                    let a = e.get(s);
                    null != a && (i && (a += this.getStackedYValueWorking(e, s)),
            ...
            _positionBullet(e) {
                ...
                if (t) {
                    ...
                    if (this._shouldShowBullet(r, l)) {
                        ...
                        if (null != o) {
                            let e;
                            n == u ? ("value" == o ? e = this._yField : "open" == o ? e = this._yOpenField : "high" == o ? e = this._yHighField : "low" == o && (e = this._yLowField),
                            e && (l = d.getDataItemPositionY(i, e, 0, this.get("vcy", 1)),
                            h = d.get("renderer").positionToPoint(l),
                            p = h.y,
                            m = c + b * s)) : ("value" == o ? e = this._xField : "open" == o ? e = this._xOpenField : "high" == o ? e = this._xHighField : "low" == o && (e = this._xLowField),
                            e && (r = u.getDataItemPositionX(i, e, 0, this.get("vcx", 1)),
                            ...
                            if (n == u) {
                                ...
                                if (i) {
                                    let s = i.bounds()
                                      ...
                                      , o = p;
                                    p = s.top,
                                    "down" == x ? p = s.bottom - a.top : "auto" == x ? e && (o < e.plotContainer.height() / 2 ? p = s.bottom - a.top : p += a.bottom) : p += a.bottom
                                }
                                ...
                                if (i) {
                                    let s = i.bounds()
                                      ...
                                      , o = m;
                                    m = s.right,
                                    "down" == x ? m = s.left - a.right : "auto" == x ? e && (o < e.plotContainer.width() / 2 ? m = s.left - a.right : m -= a.left) : m -= a.left
                                }
                                this._bullets[r + "_" + l] = t
                            }
                        }
                        t.isType("Label") && (t.setPrivate("maxWidth", Math.abs(b)),
            ...
            resetGrouping() {
                c.each(this._dataSets, ( (e, t) => {
                    t != this._mainDataItems && u.each(t, (e => {
                        this.disposeDataItem(e)
                    }
                    ))
                }
            ...
            _afterChanged() {
                super._afterChanged(),
                this._skipped && (this._markDirtyAxes(),
                this._skipped = !1)
            }
            showDataItemTooltip(e) {
                this.getPrivate("doNotUpdateLegend") || (this.updateLegendMarker(e),
                ...
                if (t)
                    if (!this.isHidden() && this.get("visible")) {
                        ...
                        e) {
                            ...
                            m) {
                                const i = this.chart;
                                i && i.inPlot(g) ? (t.label.text.markDirtyText(),
                                t.set("tooltipTarget", this._getTooltipTarget(e)),
                                t.set("pointTo", this._display.toGlobal({
                                    x: g.x,
                                    y: g.y
            ...
            hideTooltip() {
                const e = this.get("tooltip");
                return e && e.set("tooltipTarget", this),
                super.hideTooltip()
            }
            _getTooltipTarget(e) {
                if ("bullet" == this.get("seriesTooltipTarget")) {
            ...
            updateLegendValue(e) {
                ...
                if (t) {
                    ...
                    if (i) {
                        let t = "";
                        e ? (i._setDataItem(e),
                        t = this.get("legendLabelText", i.get("text", this.get("name", "")))) : (i._setDataItem(this._emptyDataItem),
                        t = this.get("legendRangeLabelText", this.get("legendLabelText", i.get("text", this.get("name", ""))))),
                        i.set("text", t)
                    }
                    ...
                    if (s) {
                        let t = "";
                        e ? (s._setDataItem(e),
                        t = this.get("legendValueText", s.get("text", ""))) : (s._setDataItem(this._emptyDataItem),
            ...
            _getItemReaderLabel() {
                ...
                return this.get("xAxis").isType("DateAxis") && (e += ".formatDate()"),
                e += "}; Y: {" + this._yField,
            ...
            _adjustStartIndex(e) {
                ...
                if (this.get("baseAxis") == t && t.isType("DateAxis")) {
                    ...
                    for (; o < s; ) {
                        ...
                        {
                            const i = t.open;
                            if (o = i ? i.valueX : t.get("valueX", 0),
                            o += a,
                            !(o < s))
                                break;
                            e++
    ...
    3405: function(e, t, i) {
        ...
        class r extends a.L {
            ...
            _afterNew() {
                ...
                this._settings.themeTags = n.mergeTags(this._settings.themeTags, ["scrollbar", "xy", "chart", this._settings.orientation]);
            ...
            _updateThumb() {
                ...
                this.overlay.set("draw", (e => {
                    ...
                    s > o && ([s,o] = [o, s]),
                    a > n && ([a,n] = [n, a]),
                    "horizontal" === this.get("orientation") ? (e.moveTo(0, 0),
                    e.lineTo(s, 0),
                    e.lineTo(s, r),
                    e.lineTo(0, r),
                    e.lineTo(0, 0),
        ...
        class p extends c.R {
            ...
            _afterNew() {
                this._settings.themeTags = n.mergeTags(this._settings.themeTags, ["axis"]),
            ...
            _prepareChildren() {
                ...
                const e = this.dataItems.length;
                let t = 0;
                this._valuesDirty && (this._itemMap = {},
                u.each(this.dataItems, (e => {
                    e.setRaw("index", t),
                    this._itemMap[e.get("category")] = e,
                    t++
                }
                )),
                ...
                (this._sizeDirty || this._valuesDirty || this.isDirty("start") || this.isDirty("end") || this.isPrivateDirty("endIndex") || this.isPrivateDirty("startIndex") || this.isPrivateDirty("width") || this.isPrivateDirty("height")) && this.dataItems.length > 0 && (this._handleRangeChange(),
                this._prepareAxisItems(),
                this._updateAxisRanges())
            }
            _handleRangeChange() {
                u.each(this.series, (e => {
                    let t = this.dataItems[this.startIndex()].get("category")
                      ...
                      , a = e.get("xAxis")
                      , o = e.get("yAxis");
                    if (a instanceof p && o instanceof p)
                        e._markDirtyAxes();
                    else if (s === this) {
                        let n, r, l = o;
                        if (a === s ? (e.get("categoryXField") && (n = "categoryX"),
                        e.get("openCategoryXField") && (r = "openCategoryX")) : o === s && (e.get("categoryYField") && (n = "categoryY"),
                        e.get("openCategoryYField") && (r = "openCategoryY"),
                        l = a),
                        "ValueAxis" == l.className && (n || r)) {
                            let s, a;
            ...
            _prepareAxisItems() {
                ...
                for (let e = s; e < a; e += l) {
                    ...
                    let i = l;
                    n && (i = 1),
                    this._prepareDataItem(t, h, i),
                    h++
                }
                if (t.get("minorGridEnabled"))
                    for (let t = s; t < a; t++) {
                        let i = this.dataItems[t];
                        t % l != 0 && (this._createAssets(i, ["minor"], !0),
                        this._toggleDataItem(i, !0),
                        this._prepareDataItem(i, 0, 1),
                        o || null === (e = i.get("label")) || void 0 === e || e.setPrivate("visible", !1))
                    }
                this._updateGhost()
            }
            _prepareDataItem(e, t, i) {
                ...
                let r, l = this.indexToPosition(n, a), h = e.get("endCategory");
                h ? (r = this.categoryToIndex(h),
                d.isNumber(r) || (r = n)) : r = n;
            ...
            indexToPosition(e, t) {
                ...
                i -= s,
                i -= 1 - this.get("endLocation", 1);
                let a = (e + t - s) / i
                  , o = this.dataItems[e];
                return o && (a += o.get("deltaPosition", 0)),
                a
            }
            categoryToIndex(e) {
                let t = this._itemMap[e];
            ...
            roundAxisPosition(e, t) {
                return e += (.5 - t) / this.dataItems.length,
        ...
        class _ extends p {
            ...
            _prepareAxisItems() {
                ...
                for (let e = i; e < s; e++) {
                    ...
                    p = m[h.timeUnit];
                    let l = !1;
                    "year" != h.timeUnit && "week" != h.timeUnit && c && this.get("markUnitChange") && d.isNumber(_) && b.checkChange(a, _, c, this._root.utc) && (p = this.get("periodChangeDateFormats")[h.timeUnit],
                    i - .5 * o < x && f.pop(),
                    f.push({
                        format: p,
                        dataItem: t
                    ...
                    v = r);
                    let u = !1;
                    "day" === h.timeUnit || "week" === h.timeUnit ? i - x >= o && (u = !0) : r % h.count == 0 && r != v && (u = !0),
                    !l && u && (i - .7 * o < x && y && (s = !0),
                    s || (f.push({
                        format: p,
                        dataItem: t
        ...
        class y extends f.m {
            ...
            _adjustMinMax(e, t, i, s) {
                ...
                "millisecond" == n || "second" == n || "minute" == n || "hour" == n) {
                    ...
                    a = super._adjustMinMax(e, t, i, s);
                return this.setPrivateRaw("durationFormat", o.getFormat(a.step, a.max, n)),
                a
            }
            _formatText(e) {
        ...
        class L extends Y.$ {
            ...
            _processAxisRange(e) {
                super._processAxisRange(e),
                e.columns = new X.o(F.YS.new({}),( () => S._new(this._root, {
        ...
        class V extends R.e {
            _afterNew() {
                this._setDefault("curveFactory", (0,
                j.$)(this.get("tension", .5))),
                super._afterNew()
            }
            _updateChildren() {
                this.isDirty("tension") && (this.set("curveFactory", (0,
                j.$)(this.get("tension", .5))),
                this._valuesDirty = !0),
                super._updateChildren()
            }
        ...
        class z extends R.e {
            _afterNew() {
                this._setDefault("curveFactory", U.ZP.tension(this.get("tension", .5))),
                super._afterNew()
            }
            _updateChildren() {
                this.isDirty("tension") && (this.set("curveFactory", U.ZP.tension(this.get("tension", .5))),
                this._valuesDirty = !0),
                super._updateChildren()
            }
        }
        ...
        class Z extends R.e {
            _afterNew() {
                this._setDefault("curveFactory", H),
                super._afterNew()
            }
            _getPoints(e, t) {
                let i = t.points
                  ...
                  , n = a
                  , r = o;
                t.baseAxis === t.xAxis ? (a -= s,
                n += s) : t.baseAxis === t.yAxis && (o -= s,
                r += s);
                ...
                if (this._shouldInclude(l)) {
                    ...
                    if (t.fillVisible) {
                        let i = l
                          ...
                          , m = c
                          , b = u;
                        if (t.baseAxis === t.xAxis ? (d = t.basePosY,
                        b = t.basePosY) : t.baseAxis === t.yAxis && (i = t.basePosX,
                        m = t.basePosX),
                        t.getOpen) {
                            let l = e.get(t.xOpenField)
                              , h = e.get(t.yOpenField);
                            if (null != l && null != h)
                                if (a = e.get("openLocationX", t.openLocationX),
                                o = e.get("openLocationY", t.openLocationY),
                                n = a,
                                r = o,
                                t.baseAxis === t.xAxis ? (a -= s,
                                ...
                                t.stacked) {
                                    ...
                                    s ? (i = t.xAxis.getDataItemPositionX(s, t.xField, a, s.component.get("vcx")),
                                    m = t.xAxis.getDataItemPositionX(s, t.xField, n, s.component.get("vcx"))) : t.yAxis === t.baseAxis ? (i = t.basePosX,
                                    m = t.basePosX) : t.baseAxis === t.yAxis && (i = t.xAxis.getDataItemPositionX(e, t.xOpenField, a, t.vcx),
                                    m = t.xAxis.getDataItemPositionX(e, t.xOpenField, n, t.vcx)),
                                    l ? (d = t.yAxis.getDataItemPositionY(l, t.yField, o, l.component.get("vcy")),
                                    b = t.yAxis.getDataItemPositionY(l, t.yField, r, l.component.get("vcy"))) : t.xAxis === t.baseAxis ? (d = t.basePosY,
                                    b = t.basePosY) : t.baseAxis === t.yAxis && (d = t.yAxis.getDataItemPositionY(e, t.yOpenField, o, t.vcy),
                                    b = t.yAxis.getDataItemPositionY(e, t.yOpenField, r, t.vcy))
                                } else
                                    i = t.xAxis.getDataItemPositionX(e, t.xOpenField, a, t.vcx),
                                    d = t.yAxis.getDataItemPositionY(e, t.yOpenField, o, t.vcy),
                                    m = t.xAxis.getDataItemPositionX(e, t.xOpenField, n, t.vcx),
                                    b = t.yAxis.getDataItemPositionY(e, t.yOpenField, r, t.vcy)
                        }
